...
|---|---|---|
| [SLAI internship](https://github.com/Lunciare/SLAI-internship) | Research internship at Shenzhen Loop Area Institute on dysarthria detection and dataset reliability. Combines Russian speech dataset auditing, cross-lingual representation analysis, and speaker-disjoint experiments on TORGO and UASpeech. Investigates how non-speech audio and recording conditions influence classification results. Includes analysis code, experimental results, reports, and posters. | Python · PyTorch · Hugging Face Transformers · librosa · XGBoost |
